...
vspec = importlib.util.spec_from_file_location(
    "version", str(Path(__file__).resolve().parent / "pay" / "version.py")
)
...
setup(
    name="pay",
    description="Demo Credit Card Payment",
    ...
    license="MIT",
    author="Youngpil Yoon",
    author_email="yngpil.yoon@gmail.com",
    # Use the URL to the github repo.
    url="https://github.com/ziwon/pay",
    download_url=(f"https://github.com/ziwon/" f"pay/archive/{version}.tar.gz"),
    keywords=[

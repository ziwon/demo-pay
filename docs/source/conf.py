...
# -*- coding: utf-8 -*-
#
# pay documentation build configuration file
#
...
latex_documents = [
    (master_doc, 'pay.tex', 'pay Documentation',
     'ziwon', 'manual'),
]
...
man_pages = [
    (master_doc, 'pay', 'pay Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pay', 'pay Documentation',
     author, 'pay', 'One line description of project.',
     'Miscellaneous'),
]
